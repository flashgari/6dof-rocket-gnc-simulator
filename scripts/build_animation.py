...
<main>
  ...
  <p>Synced playback of the disturbed open-loop failure, ideal body-torque control, PD thrust-vector control, and LQR thrust-vector control.</p>
  <div class="toolbar">
...
function drawLane(series, lane) {{
  ...
  ctx.fillText('trajectory and attitude', left + 26, 60);
